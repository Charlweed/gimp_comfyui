...
class FluxNegUpscaleSdxl0Dot4Dialogs(WorkflowDialogFactory):
    ...
    def new_workflow_dialog(self, 
        ...
        entry_122_ckpt_name: Gtk.Entry = Gtk.Entry.new()
        entry_122_ckpt_name.set_hexpand(True)
        ...
        entry_122_lora_name: Gtk.Entry = Gtk.Entry.new()
        entry_122_lora_name.set_hexpand(True)
        ...
        entry_122_lora_model_strength: Gtk.Entry = Gtk.Entry.new()
        ...
        entry_122_lora_clip_strength: Gtk.Entry = Gtk.Entry.new()
        label_122_positive: Gtk.Label = Gtk.Label.new("Positive")
        entry_122_positive: Gtk.Entry = Gtk.Entry.new()
        entry_122_positive.set_hexpand(True)
        label_122_negative: Gtk.Label = Gtk.Label.new("Negative")
        entry_122_negative: Gtk.Entry = Gtk.Entry.new()
        entry_122_negative.set_hexpand(True)
        label_122_token_normalization: Gtk.Label = Gtk.Label.new("Token_Normalization")
        entry_122_token_normalization: Gtk.Entry = Gtk.Entry.new()
        entry_122_token_normalization.set_hexpand(True)
        label_122_weight_interpretation: Gtk.Label = Gtk.Label.new("Weight_Interpretation")
        entry_122_weight_interpretation: Gtk.Entry = Gtk.Entry.new()
        entry_122_weight_interpretation.set_hexpand(True)
        ...
        grid_122.attach(entry_122_ckpt_name,             left=1, top=0, width=2, height=1)  # noqa
        grid_122.attach(label_122_vae_name,              left=0, top=1, width=1, height=1)  # noqa
        grid_122.attach(comboboxtext_122_vae_name,       left=1, top=1, width=2, height=1)  # noqa
        grid_122.attach(label_122_clip_skip,             left=0, top=2, width=1, height=1)  # noqa
        grid_122.attach(entry_122_clip_skip,             left=1, top=2, width=2, height=1)  # noqa
        grid_122.attach(label_122_lora_name,             left=0, top=3, width=1, height=1)  # noqa
        grid_122.attach(entry_122_lora_name,             left=1, top=3, width=2, height=1)  # noqa
        grid_122.attach(label_122_lora_model_strength,   left=0, top=4, width=1, height=1)  # noqa
        grid_122.attach(entry_122_lora_model_strength,   left=1, top=4, width=2, height=1)  # noqa
        grid_122.attach(label_122_lora_clip_strength,    left=0, top=5, width=1, height=1)  # noqa
        grid_122.attach(entry_122_lora_clip_strength,    left=1, top=5, width=2, height=1)  # noqa
        grid_122.attach(label_122_positive,              left=0, top=6, width=1, height=1)  # noqa
        grid_122.attach(entry_122_positive,              left=1, top=6, width=2, height=1)  # noqa
        grid_122.attach(label_122_negative,              left=0, top=7, width=1, height=1)  # noqa
        grid_122.attach(entry_122_negative,              left=1, top=7, width=2, height=1)  # noqa
        grid_122.attach(label_122_token_normalization,   left=0, top=8, width=1, height=1)  # noqa
        grid_122.attach(entry_122_token_normalization,   left=1, top=8, width=2, height=1)  # noqa
        grid_122.attach(label_122_weight_interpretation, left=0, top=9, width=1, height=1)  # noqa
        grid_122.attach(entry_122_weight_interpretation, left=1, top=9, width=2, height=1)  # noqa
        grid_122.attach(label_122_empty_latent_width,    left=0, top=10, width=1, height=1)  # noqa
        grid_122.attach(entry_122_empty_latent_width,    left=1, top=10, width=2, height=1)  # noqa
        grid_122.attach(label_122_empty_latent_height,   left=0, top=11, width=1, height=1)  # noqa
        grid_122.attach(entry_122_empty_latent_height,   left=1, top=11, width=2, height=1)  # noqa
        grid_122.attach(label_122_batch_size,            left=0, top=12, width=1, height=1)  # noqa
        grid_122.attach(entry_122_batch_size,            left=1, top=12, width=2, height=1)  # noqa
        ...
        entry_123_upscale_by: Gtk.Entry = Gtk.Entry.new()
        ...
        entry_123_cfg: Gtk.Entry = Gtk.Entry.new()
        entry_123_cfg.set_text(str(2.0))
        entry_123_cfg.set_name("entry_123_cfg")
        entry_123_cfg.set_hexpand(True)
        validate_in_bounds(entry_widget=entry_123_cfg,
                           minimum=0, maximum=None,  # noqa
                           int_only=False,
                           track_invalid_widgets=track_invalid_widgets)
        ...
        def change_handler_123_cfg(source, **args):  # noqa
            pass
        entry_123_cfg.connect(SIG_CHANGED, change_handler_123_cfg)

        def getter_123_cfg() -> float:
            return float(entry_123_cfg.get_text())

        def setter_123_cfg(a_val: float):
            entry_123_cfg.set_text(str(a_val))
        widget_getters[entry_123_cfg.get_name()] = getter_123_cfg
        widget_setters[entry_123_cfg.get_name()] = setter_123_cfg

        label_123_sampler_name: Gtk.Label = Gtk.Label.new("Sampler_Name")
        entry_123_sampler_name: Gtk.Entry = Gtk.Entry.new()
        entry_123_sampler_name.set_hexpand(True)
        label_123_scheduler: Gtk.Label = Gtk.Label.new("Scheduler")
        entry_123_scheduler: Gtk.Entry = Gtk.Entry.new()
        entry_123_scheduler.set_hexpand(True)
        label_123_denoise: Gtk.Label = Gtk.Label.new("Denoise")
        label_123_denoise.set_margin_start(8)
        entry_123_denoise: Gtk.Entry = Gtk.Entry.new()
        label_123_mode_type: Gtk.Label = Gtk.Label.new("Mode_Type")
        entry_123_mode_type: Gtk.Entry = Gtk.Entry.new()
        entry_123_mode_type.set_hexpand(True)
        ...
        entry_123_seam_fix_mode: Gtk.Entry = Gtk.Entry.new()
        entry_123_seam_fix_mode.set_hexpand(True)
        ...
        entry_123_seam_fix_denoise: Gtk.Entry = Gtk.Entry.new()
        ...
        checkbutton_123_force_uniform_tiles: Gtk.CheckButton = Gtk.CheckButton.new_with_label("Force_Uniform_Tiles")  # noqa

        checkbutton_123_tiled_decode: Gtk.CheckButton = Gtk.CheckButton.new_with_label("Tiled_Decode")  # noqa

        grid_123: Gtk.Grid = Gtk.Grid.new()
        grid_123.attach(label_123_upscale_by,                left=0, top=0, width=1, height=1)  # noqa
        grid_123.attach(entry_123_upscale_by,                left=1, top=0, width=2, height=1)  # noqa
        ...
        grid_123.attach(label_123_steps,                     left=4, top=1, width=1, height=1)  # noqa
        grid_123.attach(entry_123_steps,                     left=5, top=1, width=3, height=1)  # noqa
        grid_123.attach(label_123_cfg,                       left=0, top=2, width=1, height=1)  # noqa
        grid_123.attach(entry_123_cfg,                       left=1, top=2, width=7, height=1)  # noqa
        grid_123.attach(label_123_sampler_name,              left=0, top=3, width=1, height=1)  # noqa
        grid_123.attach(entry_123_sampler_name,              left=1, top=3, width=7, height=1)  # noqa
        grid_123.attach(label_123_scheduler,                 left=0, top=4, width=1, height=1)  # noqa
        grid_123.attach(entry_123_scheduler,                 left=1, top=4, width=7, height=1)  # noqa
        grid_123.attach(label_123_denoise,                   left=0, top=5, width=1, height=1)  # noqa
        grid_123.attach(entry_123_denoise,                   left=1, top=5, width=7, height=1)  # noqa
        grid_123.attach(label_123_mode_type,                 left=0, top=6, width=1, height=1)  # noqa
        grid_123.attach(entry_123_mode_type,                 left=1, top=6, width=7, height=1)  # noqa
        grid_123.attach(label_123_mask_blur,                 left=0, top=7, width=1, height=1)  # noqa
        grid_123.attach(entry_123_mask_blur,                 left=1, top=7, width=7, height=1)  # noqa
        grid_123.attach(label_123_tile_padding,              left=0, top=8, width=1, height=1)  # noqa
        grid_123.attach(entry_123_tile_padding,              left=1, top=8, width=7, height=1)  # noqa
        grid_123.attach(label_123_seam_fix_mode,             left=0, top=9, width=1, height=1)  # noqa
        grid_123.attach(entry_123_seam_fix_mode,             left=1, top=9, width=7, height=1)  # noqa
        grid_123.attach(label_123_seam_fix_denoise,          left=0, top=10, width=1, height=1)  # noqa
        grid_123.attach(entry_123_seam_fix_denoise,          left=1, top=10, width=7, height=1)  # noqa
        grid_123.attach(label_123_seam_fix_width,            left=0, top=11, width=1, height=1)  # noqa
        grid_123.attach(entry_123_seam_fix_width,            left=1, top=11, width=7, height=1)  # noqa
        grid_123.attach(label_123_seam_fix_mask_blur,        left=0, top=12, width=1, height=1)  # noqa
        grid_123.attach(entry_123_seam_fix_mask_blur,        left=1, top=12, width=7, height=1)  # noqa
        grid_123.attach(label_123_seam_fix_padding,          left=0, top=13, width=1, height=1)  # noqa
        grid_123.attach(entry_123_seam_fix_padding,          left=1, top=13, width=7, height=1)  # noqa
        grid_123.attach(checkbutton_123_force_uniform_tiles, left=0, top=14, width=8, height=1)  # noqa
        grid_123.attach(checkbutton_123_tiled_decode,        left=0, top=15, width=8, height=1)  # noqa
        ...
        entry_124_model_name: Gtk.Entry = Gtk.Entry.new()
        entry_124_model_name.set_hexpand(True)
        grid_124: Gtk.Grid = Gtk.Grid.new()
        grid_124.attach(label_124_model_name, left=0, top=0, width=1, height=1)  # noqa
        grid_124.attach(entry_124_model_name, left=1, top=0, width=2, height=1)  # noqa
