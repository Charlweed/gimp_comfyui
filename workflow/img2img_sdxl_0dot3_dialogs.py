...
class Img2ImgSdxl0Dot3Dialogs(WorkflowDialogFactory):
    ...
    def new_workflow_dialog(self, 
        ...
        # New Frame
        frame_checkpointloadersimple_014load_checkpoint_base: Gtk.Frame = Gtk.Frame.new(label="Load Checkpoint Base        #14")  # noqa
        ...
        comboboxtext_14_ckpt_name.set_active(13)
        ...
        widget_getters[comboboxtext_14_ckpt_name.get_name()] = comboboxtext_14_ckpt_name.get_active_text  # noqa
        widget_setters[comboboxtext_14_ckpt_name.get_name()] = setter_14_ckpt_name  # noqa

        grid_14: Gtk.Grid = Gtk.Grid.new()
        grid_14.attach(label_14_ckpt_name,        left=0, top=0, width=1, height=1)  # noqa
        grid_14.attach(comboboxtext_14_ckpt_name, left=1, top=0, width=3, height=1)  # noqa
        ...
        # New Frame
        frame_cliptextencodesdxl_016positivetextencodesdxl: Gtk.Frame = Gtk.Frame.new(label="PositiveTextEncodeSDXL        #16")  # noqa
        ...
        widget_getters[entry_16_width.get_name()] = getter_16_width  # noqa
        widget_setters[entry_16_width.get_name()] = setter_16_width  # noqa
        ...
        widget_getters[entry_16_height.get_name()] = getter_16_height  # noqa
        widget_setters[entry_16_height.get_name()] = setter_16_height  # noqa
        ...
        widget_getters[entry_16_crop_w.get_name()] = getter_16_crop_w  # noqa
        widget_setters[entry_16_crop_w.get_name()] = setter_16_crop_w  # noqa
        ...
        widget_getters[entry_16_crop_h.get_name()] = getter_16_crop_h  # noqa
        widget_setters[entry_16_crop_h.get_name()] = setter_16_crop_h  # noqa
        ...
        widget_getters[entry_16_target_width.get_name()] = getter_16_target_width  # noqa
        widget_setters[entry_16_target_width.get_name()] = setter_16_target_width  # noqa
        ...
        widget_getters[entry_16_target_height.get_name()] = getter_16_target_height  # noqa
        widget_setters[entry_16_target_height.get_name()] = setter_16_target_height  # noqa
        ...
        scrolled_window_16_text_g = Gtk.ScrolledWindow()
        scrolled_window_16_text_g.add(textview_16_text_g)  # noqa
        scrolled_window_16_text_g.set_size_request(288, 96)
        ...
        # Create a ScrolledWindow to hold the TextView
        scrolled_window_16_text_l = Gtk.ScrolledWindow()
        scrolled_window_16_text_l.add(textview_16_text_l)  # noqa
        scrolled_window_16_text_l.set_size_request(288, 96)
        ...
        grid_16.attach(scrolled_window_16_text_g, left=1, top=1, width=23, height=1)  # noqa
        grid_16.attach(label_16_text_l,           left=0, top=2, width=1, height=1)  # noqa
        grid_16.attach(scrolled_window_16_text_l, left=1, top=2, width=23, height=1)  # noqa
        ...
        # New Frame
        frame_cliptextencodesdxl_019negativetextencodesdxl: Gtk.Frame = Gtk.Frame.new(label="NegativeTextEncodeSDXL        #19")  # noqa
        ...
        widget_getters[entry_19_width.get_name()] = getter_19_width  # noqa
        widget_setters[entry_19_width.get_name()] = setter_19_width  # noqa
        ...
        widget_getters[entry_19_height.get_name()] = getter_19_height  # noqa
        widget_setters[entry_19_height.get_name()] = setter_19_height  # noqa
        ...
        widget_getters[entry_19_crop_w.get_name()] = getter_19_crop_w  # noqa
        widget_setters[entry_19_crop_w.get_name()] = setter_19_crop_w  # noqa
        ...
        widget_getters[entry_19_crop_h.get_name()] = getter_19_crop_h  # noqa
        widget_setters[entry_19_crop_h.get_name()] = setter_19_crop_h  # noqa
        ...
        widget_getters[entry_19_target_width.get_name()] = getter_19_target_width  # noqa
        widget_setters[entry_19_target_width.get_name()] = setter_19_target_width  # noqa
        ...
        widget_getters[entry_19_target_height.get_name()] = getter_19_target_height  # noqa
        widget_setters[entry_19_target_height.get_name()] = setter_19_target_height  # noqa
        ...
        # Create a ScrolledWindow to hold the TextView
        scrolled_window_19_text_g = Gtk.ScrolledWindow()
        scrolled_window_19_text_g.add(textview_19_text_g)  # noqa
        scrolled_window_19_text_g.set_size_request(288, 96)
        ...
        # Create a ScrolledWindow to hold the TextView
        scrolled_window_19_text_l = Gtk.ScrolledWindow()
        scrolled_window_19_text_l.add(textview_19_text_l)  # noqa
        scrolled_window_19_text_l.set_size_request(288, 96)
        ...
        grid_19.attach(scrolled_window_19_text_g, left=1, top=1, width=23, height=1)  # noqa
        grid_19.attach(label_19_text_l,           left=0, top=2, width=1, height=1)  # noqa
        grid_19.attach(scrolled_window_19_text_l, left=1, top=2, width=23, height=1)  # noqa
        ...
        # New Frame
        frame_ksampler_036ksampler: Gtk.Frame = Gtk.Frame.new(label="KSampler        #36")  # noqa
        ...
        widget_getters[entry_36_seed.get_name()] = getter_36_seed  # noqa
        widget_setters[entry_36_seed.get_name()] = setter_36_seed  # noqa
        ...
        widget_getters[entry_36_steps.get_name()] = getter_36_steps  # noqa
        widget_setters[entry_36_steps.get_name()] = setter_36_steps  # noqa
        ...
        widget_getters[comboboxtext_36_sampler_name.get_name()] = comboboxtext_36_sampler_name.get_active_text  # noqa
        widget_setters[comboboxtext_36_sampler_name.get_name()] = setter_36_sampler_name  # noqa
        ...
        widget_getters[comboboxtext_36_scheduler.get_name()] = comboboxtext_36_scheduler.get_active_text  # noqa
        widget_setters[comboboxtext_36_scheduler.get_name()] = setter_36_scheduler  # noqa
        ...
        grid_36.attach(label_36_steps,               left=0, top=1, width=1, height=1)  # noqa
        grid_36.attach(entry_36_steps,               left=1, top=1, width=3, height=1)  # noqa
        grid_36.attach(label_36_cfg,                 left=0, top=2, width=1, height=1)  # noqa
        grid_36.attach(scale_36_cfg,                 left=1, top=2, width=3, height=1)  # noqa
        grid_36.attach(label_36_sampler_name,        left=0, top=3, width=1, height=1)  # noqa
        grid_36.attach(comboboxtext_36_sampler_name, left=1, top=3, width=3, height=1)  # noqa
        grid_36.attach(label_36_scheduler,           left=0, top=4, width=1, height=1)  # noqa
        grid_36.attach(comboboxtext_36_scheduler,    left=1, top=4, width=3, height=1)  # noqa
        grid_36.attach(label_36_denoise,             left=0, top=5, width=1, height=1)  # noqa
        grid_36.attach(scale_36_denoise,             left=1, top=5, width=3, height=1)  # noqa
        grid_36.set_column_homogeneous(False)
        grid_36.set_row_homogeneous(False)
        frame_ksampler_036ksampler.add(widget=grid_36)  # noqa

        # New Frame
        frame_vaeloader_037load_vae: Gtk.Frame = Gtk.Frame.new(label="Load VAE        #37")  # noqa
        ...
        if not combo_values_37_vae_name:
            raise ValueError(fr"No models retrieved from ComfyUI")
        combo_values_37_vae_name = ['Baked VAE'] + combo_values_37_vae_name
        ...
        comboboxtext_37_vae_name.set_active(2)
        ...
        widget_getters[comboboxtext_37_vae_name.get_name()] = comboboxtext_37_vae_name.get_active_text  # noqa
        widget_setters[comboboxtext_37_vae_name.get_name()] = setter_37_vae_name  # noqa

        grid_37: Gtk.Grid = Gtk.Grid.new()
        grid_37.attach(label_37_vae_name,        left=0, top=0, width=1, height=1)  # noqa
        grid_37.attach(comboboxtext_37_vae_name, left=1, top=0, width=3, height=1)  # noqa
        grid_37.set_column_homogeneous(False)
        grid_37.set_row_homogeneous(False)
        frame_vaeloader_037load_vae.add(widget=grid_37)  # noqa

        # New Frame
        frame_loadimage_038load_image: Gtk.Frame = Gtk.Frame.new(label="Load Image: (select layer)        #38")  # noqa
        ...
        widget_getters[treeview_38_image.get_name()] = treeview_38_image.get_selected_png_leaf  # noqa

        grid_38: Gtk.Grid = Gtk.Grid.new()
        grid_38.attach(label_38_image,    left=0, top=0, width=1, height=1)  # noqa
        grid_38.attach(treeview_38_image, left=1, top=0, width=3, height=1)  # noqa
        ...
        # New Frame
        frame_imagescale_040upscale_image: Gtk.Frame = Gtk.Frame.new(label="Upscale Image        #40")  # noqa
        ...
        widget_getters[comboboxtext_40_upscale_method.get_name()] = comboboxtext_40_upscale_method.get_active_text  # noqa
        widget_setters[comboboxtext_40_upscale_method.get_name()] = setter_40_upscale_method  # noqa
        ...
        widget_getters[entry_40_width.get_name()] = getter_40_width  # noqa
        widget_setters[entry_40_width.get_name()] = setter_40_width  # noqa
        ...
        widget_getters[entry_40_height.get_name()] = getter_40_height  # noqa
        widget_setters[entry_40_height.get_name()] = setter_40_height  # noqa
        ...
        widget_getters[comboboxtext_40_crop.get_name()] = comboboxtext_40_crop.get_active_text  # noqa
        widget_setters[comboboxtext_40_crop.get_name()] = setter_40_crop  # noqa

        grid_40: Gtk.Grid = Gtk.Grid.new()
        grid_40.attach(label_40_upscale_method,        left=0, top=0, width=1, height=1)  # noqa
        grid_40.attach(comboboxtext_40_upscale_method, left=1, top=0, width=11, height=1)  # noqa
        ...
        subject_box.pack_start(child=frame_checkpointloadersimple_014load_checkpoint_base, expand=False, fill=False, padding=0)  # noqa
        subject_box.pack_start(child=frame_cliptextencodesdxl_016positivetextencodesdxl, expand=True, fill=True, padding=0)  # noqa
        subject_box.pack_start(child=frame_cliptextencodesdxl_019negativetextencodesdxl, expand=True, fill=True, padding=0)  # noqa
        subject_box.pack_start(child=frame_ksampler_036ksampler, expand=False, fill=False, padding=0)  # noqa
        subject_box.pack_start(child=frame_vaeloader_037load_vae, expand=False, fill=False, padding=0)  # noqa
        subject_box.pack_start(child=frame_loadimage_038load_image, expand=False, fill=False, padding=0)  # noqa
        subject_box.pack_start(child=frame_imagescale_040upscale_image, expand=False, fill=False, padding=0)  # noqa
