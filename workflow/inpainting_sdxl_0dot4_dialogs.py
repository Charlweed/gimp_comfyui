...
class InpaintingSdxl0Dot4Dialogs(WorkflowDialogFactory):
    ...
    def new_workflow_dialog(self, 
        ...
        # New Frame
        frame_loadimage_001base_image: Gtk.Frame = Gtk.Frame.new(label="Base Image: (select layer)")  # noqa
        ...
        widget_getters[treeview_1_image.get_name()] = treeview_1_image.get_selected_png_leaf

        grid_1: Gtk.Grid = Gtk.Grid.new()
        grid_1.attach(label_1_image,    left=0, top=0, width=1, height=1)  # noqa
        grid_1.attach(treeview_1_image, left=1, top=0, width=2, height=1)  # noqa
        grid_1.set_column_homogeneous(False)
        grid_1.set_row_homogeneous(False)
        frame_loadimage_001base_image.add(widget=grid_1)  # noqa

        # New Frame
        frame_loadimage_002mask_image: Gtk.Frame = Gtk.Frame.new(label="Mask Image: (select layer)")  # noqa
        ...
        widget_getters[treeview_2_image.get_name()] = treeview_2_image.get_selected_png_leaf

        grid_2: Gtk.Grid = Gtk.Grid.new()
        grid_2.attach(label_2_image,    left=0, top=0, width=1, height=1)  # noqa
        grid_2.attach(treeview_2_image, left=1, top=0, width=2, height=1)  # noqa
        grid_2.set_column_homogeneous(False)
        grid_2.set_row_homogeneous(False)
        frame_loadimage_002mask_image.add(widget=grid_2)  # noqa

        # New Frame
        frame_vaeencodeforinpaint_004vae_encode_for_inpainting: Gtk.Frame = Gtk.Frame.new(label="VAE Encode (for Inpainting)")  # noqa
        ...
        entry_4_grow_mask_by: Gtk.Entry = Gtk.Entry.new()
        grid_4: Gtk.Grid = Gtk.Grid.new()
        grid_4.attach(label_4_grow_mask_by, left=0, top=0, width=1, height=1)  # noqa
        grid_4.attach(entry_4_grow_mask_by, left=1, top=0, width=2, height=1)  # noqa
        ...
        # New Frame
        frame_checkpointloadersimple_005load_checkpoint: Gtk.Frame = Gtk.Frame.new(label="Load Checkpoint")  # noqa
        ...
        widget_getters[comboboxtext_5_ckpt_name.get_name()] = comboboxtext_5_ckpt_name.get_active_text
        widget_setters[comboboxtext_5_ckpt_name.get_name()] = setter_5_ckpt_name

        grid_5: Gtk.Grid = Gtk.Grid.new()
        grid_5.attach(label_5_ckpt_name,        left=0, top=0, width=1, height=1)  # noqa
        grid_5.attach(comboboxtext_5_ckpt_name, left=1, top=0, width=2, height=1)  # noqa
        ...
        # New Frame
        frame_unetloader_006load_diffusion_model: Gtk.Frame = Gtk.Frame.new(label="Load Diffusion Model")  # noqa
        ...
        widget_getters[comboboxtext_6_unet_name.get_name()] = comboboxtext_6_unet_name.get_active_text
        widget_setters[comboboxtext_6_unet_name.get_name()] = setter_6_unet_name
        ...
        widget_getters[comboboxtext_6_weight_dtype.get_name()] = comboboxtext_6_weight_dtype.get_active_text
        widget_setters[comboboxtext_6_weight_dtype.get_name()] = setter_6_weight_dtype

        grid_6: Gtk.Grid = Gtk.Grid.new()
        grid_6.attach(label_6_unet_name,           left=0, top=0, width=1, height=1)  # noqa
        grid_6.attach(comboboxtext_6_unet_name,    left=1, top=0, width=2, height=1)  # noqa
        grid_6.attach(label_6_weight_dtype,        left=0, top=1, width=1, height=1)  # noqa
        grid_6.attach(comboboxtext_6_weight_dtype, left=1, top=1, width=2, height=1)  # noqa
        ...
        # New Frame
        frame_loraloader_007load_lora: Gtk.Frame = Gtk.Frame.new(label="Load LoRA")  # noqa
        ...
        entry_7_lora_name: Gtk.Entry = Gtk.Entry.new()
        entry_7_lora_name.set_hexpand(True)
        ...
        entry_7_strength_model: Gtk.Entry = Gtk.Entry.new()
        ...
        entry_7_strength_clip: Gtk.Entry = Gtk.Entry.new()
        grid_7: Gtk.Grid = Gtk.Grid.new()
        grid_7.attach(label_7_lora_name,      left=0, top=0, width=1, height=1)  # noqa
        grid_7.attach(entry_7_lora_name,      left=1, top=0, width=2, height=1)  # noqa
        grid_7.attach(label_7_strength_model, left=0, top=1, width=1, height=1)  # noqa
        grid_7.attach(entry_7_strength_model, left=1, top=1, width=2, height=1)  # noqa
        grid_7.attach(label_7_strength_clip,  left=0, top=2, width=1, height=1)  # noqa
        grid_7.attach(entry_7_strength_clip,  left=1, top=2, width=2, height=1)  # noqa
        grid_7.set_column_homogeneous(False)
        grid_7.set_row_homogeneous(False)
        frame_loraloader_007load_lora.add(widget=grid_7)  # noqa

        # New Frame
        frame_vaeencode_008vae_encode: Gtk.Frame = Gtk.Frame.new(label="VAE Encode")  # noqa
        frame_vaeencode_008vae_encode.set_shadow_type(Gtk.ShadowType.ETCHED_OUT)  # noqa
        grid_8: Gtk.Grid = Gtk.Grid.new()
        grid_8.set_column_homogeneous(False)
        grid_8.set_row_homogeneous(False)
        frame_vaeencode_008vae_encode.add(widget=grid_8)  # noqa

        # New Frame
        frame_cliptextencode_009positive_prompt: Gtk.Frame = Gtk.Frame.new(label="Positive Prompt")  # noqa
        ...
        grid_9.attach(textview_9_text, left=1, top=0, width=2, height=1)  # noqa
        ...
        # New Frame
        frame_cliptextencode_010negative_prompt: Gtk.Frame = Gtk.Frame.new(label="Negative Prompt")  # noqa
        ...
        grid_10.attach(textview_10_text, left=1, top=0, width=2, height=1)  # noqa
        ...
        # New Frame
        frame_modelsamplingdiscrete_011modelsamplingdiscrete: Gtk.Frame = Gtk.Frame.new(label="ModelSamplingDiscrete")  # noqa
        ...
        entry_11_sampling: Gtk.Entry = Gtk.Entry.new()
        entry_11_sampling.set_hexpand(True)
        ...
        grid_11.attach(entry_11_sampling,   left=1, top=0, width=2, height=1)  # noqa
        grid_11.attach(checkbutton_11_zsnr, left=0, top=1, width=3, height=1)  # noqa
        ...
        # New Frame
        frame_ksampler_012ksampler: Gtk.Frame = Gtk.Frame.new(label="KSampler")  # noqa
        ...
        widget_getters[entry_12_seed.get_name()] = getter_12_seed
        widget_setters[entry_12_seed.get_name()] = setter_12_seed
        ...
        widget_getters[entry_12_steps.get_name()] = getter_12_steps
        widget_setters[entry_12_steps.get_name()] = setter_12_steps
        ...
        widget_getters[comboboxtext_12_sampler_name.get_name()] = comboboxtext_12_sampler_name.get_active_text
        widget_setters[comboboxtext_12_sampler_name.get_name()] = setter_12_sampler_name
        ...
        widget_getters[comboboxtext_12_scheduler.get_name()] = comboboxtext_12_scheduler.get_active_text
        widget_setters[comboboxtext_12_scheduler.get_name()] = setter_12_scheduler
        ...
        grid_12.attach(label_12_steps,               left=4, top=0, width=1, height=1)  # noqa
        grid_12.attach(entry_12_steps,               left=5, top=0, width=3, height=1)  # noqa
        grid_12.attach(label_12_cfg,                 left=0, top=1, width=1, height=1)  # noqa
        grid_12.attach(scale_12_cfg,                 left=1, top=1, width=7, height=1)  # noqa
        grid_12.attach(label_12_sampler_name,        left=0, top=2, width=1, height=1)  # noqa
        grid_12.attach(comboboxtext_12_sampler_name, left=1, top=2, width=7, height=1)  # noqa
        grid_12.attach(label_12_scheduler,           left=0, top=3, width=1, height=1)  # noqa
        grid_12.attach(comboboxtext_12_scheduler,    left=1, top=3, width=7, height=1)  # noqa
        grid_12.attach(label_12_denoise,             left=0, top=4, width=1, height=1)  # noqa
        grid_12.attach(scale_12_denoise,             left=1, top=4, width=7, height=1)  # noqa
        grid_12.set_column_homogeneous(False)
        grid_12.set_row_homogeneous(False)
        frame_ksampler_012ksampler.add(widget=grid_12)  # noqa

        # New Frame
        frame_vaedecode_013vae_decode: Gtk.Frame = Gtk.Frame.new(label="VAE Decode")  # noqa
        frame_vaedecode_013vae_decode.set_shadow_type(Gtk.ShadowType.ETCHED_OUT)  # noqa
        grid_13: Gtk.Grid = Gtk.Grid.new()
        grid_13.set_column_homogeneous(False)
        grid_13.set_row_homogeneous(False)
        frame_vaedecode_013vae_decode.add(widget=grid_13)  # noqa

        # New Frame
        frame_saveimage_014save_image: Gtk.Frame = Gtk.Frame.new(label="Save Image")  # noqa
        ...
        entry_14_filename_prefix.set_text("generated")
        ...
        grid_14.attach(entry_14_filename_prefix, left=1, top=0, width=2, height=1)  # noqa
        ...
        # New Frame
        frame_setlatentnoisemask_015set_latent_noise_mask: Gtk.Frame = Gtk.Frame.new(label="Set Latent Noise Mask")  # noqa
        frame_setlatentnoisemask_015set_latent_noise_mask.set_shadow_type(Gtk.ShadowType.ETCHED_OUT)  # noqa
        grid_15: Gtk.Grid = Gtk.Grid.new()
        grid_15.set_column_homogeneous(False)
        grid_15.set_row_homogeneous(False)
        frame_setlatentnoisemask_015set_latent_noise_mask.add(widget=grid_15)  # noqa
        content_area: Gtk.Box = dialog.get_content_area()
        content_area.pack_start(child=frame_loadimage_001base_image, expand=False, fill=False, padding=0)  # noqa
        content_area.pack_start(child=frame_loadimage_002mask_image, expand=False, fill=False, padding=0)  # noqa
        content_area.pack_start(child=frame_vaeencodeforinpaint_004vae_encode_for_inpainting, expand=False, fill=False, padding=0)  # noqa
        content_area.pack_start(child=frame_checkpointloadersimple_005load_checkpoint, expand=False, fill=False, padding=0)  # noqa
        content_area.pack_start(child=frame_unetloader_006load_diffusion_model, expand=False, fill=False, padding=0)  # noqa
        content_area.pack_start(child=frame_loraloader_007load_lora, expand=False, fill=False, padding=0)  # noqa
        content_area.pack_start(child=frame_vaeencode_008vae_encode, expand=False, fill=False, padding=0)  # noqa
        content_area.pack_start(child=frame_cliptextencode_009positive_prompt, expand=True, fill=True, padding=0)  # noqa
        content_area.pack_start(child=frame_cliptextencode_010negative_prompt, expand=True, fill=True, padding=0)  # noqa
        content_area.pack_start(child=frame_modelsamplingdiscrete_011modelsamplingdiscrete, expand=False, fill=False, padding=0)  # noqa
        content_area.pack_start(child=frame_ksampler_012ksampler, expand=False, fill=False, padding=0)  # noqa
        content_area.pack_start(child=frame_vaedecode_013vae_decode, expand=False, fill=False, padding=0)  # noqa
        content_area.pack_start(child=frame_saveimage_014save_image, expand=False, fill=False, padding=0)  # noqa
        content_area.pack_start(child=frame_setlatentnoisemask_015set_latent_noise_mask, expand=False, fill=False, padding=0)  # noqa
